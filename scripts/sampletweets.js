var sampleTweets = {
  'statuses': [
    {
      'text': 'iphones are amazing! love the big screen and sleek design #iphone'
    },
    {
      'text': 'iphones are amazing! love the big screen and sleek design #iphone'
    },
...
// var stringifiedTweets = JSON.stringify(sampleTweets);

// data.statuses[i].text



// Example of what Twitter API search result would look like:
/*
var data = {
  "statuses": [
    {
